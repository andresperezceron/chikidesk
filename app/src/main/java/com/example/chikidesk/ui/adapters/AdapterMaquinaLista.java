...
public class AdapterMaquinaLista extends RecyclerView.Adapter<AdapterMaquinaLista.MaquinaViewHolder> {
    ...
    public AdapterMaquinaLista(List<Maquina> maquinas, OnItemClickListener listener) {
    ...
    public static class MaquinaViewHolder extends RecyclerView.ViewHolder {
        ...
        public MaquinaViewHolder(@NonNull View itemView) {
            super(itemView);
            textNombre = itemView.findViewById(R.id.txvNombreLista);
        }
