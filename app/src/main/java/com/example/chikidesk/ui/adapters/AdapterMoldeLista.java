...
public class AdapterMoldeLista extends RecyclerView.Adapter<AdapterMoldeLista.MoldeViewHolder> {
    ...
    public AdapterMoldeLista(List<Molde> moldeList, OnItemClickListener listener) {
